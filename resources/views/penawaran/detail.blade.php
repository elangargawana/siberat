...
<div class="container d-flex flex-column gap-5 p-3">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h3 class="text-bold">Detail Penawaran</h3>
        </div>
        <div class="col-sm-6">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <p><strong>PIC :</strong> {{ $penawaran->konsumen->pic }}</p>
                    <p><strong>Perusahaan :</strong> {{ $penawaran->konsumen->perusahaan }}</p>
                    <p><strong>Alamat :</strong> {{ $penawaran->konsumen->alamat }}</p>
                    <p><strong>Nomor Seri :</strong> {{ $penawaran->nomor }}</p>
                </div>
            </div>
        </div>
    </div>
