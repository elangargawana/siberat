...
<head>
    ...
    <title>{{ env('APP_NAME', 'SIBERAT') }}</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    {{-- <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" src="{{ asset('') }}dist/img/logo-s.png" alt="Polines Logo"
    height="80" width="80">
    </div> --}}
    <div class="wrapper">
                ...
                <li class="nav-item dropdown user-menu">
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <li class="user-footer">
                            ...
                            <a href="#" class="btn btn-default btn-flat float-right" data-toggle="modal" data-target="#modal-logout"><i class="fas fa-sign-out-alt"></i> <span>Keluar</span></a>
                        </li>
        ...
        <div class="modal fade" id="modal-logout" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-sm btn-default btn-flat" data-dismiss="modal">Tidak</button>
        ...
        <aside class="main-sidebar main-sidebar-custom sidebar-dark-info elevation-4">
            <a href="{{ url('') }}" class="brand-link">
                <img class="animation__shake" src="{{ asset('') }}dist/img/logo-s.png" alt="Polines Logo" height="25" width="25">
                <span class="brand-text font-weight-light "><strong>{{ env('APP_NAME', 'SIBERAT') }}</strong></span>
            </a>
            <div class="sidebar">
                <nav class="mt-2">
